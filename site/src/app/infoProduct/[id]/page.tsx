            ...
            <div className="flex flex-col items-center p-4 sm:p-6 md:p-8 bg-black min-h-screen w-full">
                ...
                <div className="flex flex-col md:flex-row bg-white w-full max-w-7xl gap-6 h-full rounded-md p-4 sm:p-6">
                    ...
                    <div className="flex flex-col items-center justify-between w-full md:w-1/2 text-center">
                        <h2 className="text-black text-2xl sm:text-3xl md:text-5xl font-bold mt-4 md:mt-0">{produto?.name}</h2>

                        <button className="bg-blue-500 font-bold cursor-pointer text-white p-3 sm:p-4 mt-6 md:mt-40 w-full max-w-[280px] rounded-full hover:scale-105 transition-transform">
                            <a
                                ...
                                className="w-full"
                            >
                                <p className="text-lg sm:text-xl">Contato</p>
                            </a>
                ...
                <div className="flex flex-col lg:flex-row w-full max-w-7xl gap-6 mt-6">
                    ...
                    <div className="flex flex-col bg-blue-500 rounded-md p-4 sm:p-6 shadow-md w-full lg:w-[35%]">
                        ...
                        {compressorData
                            ...
                            .map((compressor, i) => (
                                <Link href={`/infoProduct/${compressor.id}`} key={i}>
                                    <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-white rounded-md mb-4 hover:scale-[1.02] transition-transform">
                                        <Image
                                        ...
                                        <div className="text-black flex flex-col">
                                            ...
                                            <p className="text-xs sm:text-sm mt-1 leading-snug">
                                                Descrição do produto ou informações rápidas aqui.
                                            </p>
                                        </div>
                                    </div>
                                </Link>
